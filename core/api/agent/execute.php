 ...
 * }
 *
 * Protected by KND_AGENTS_TOKEN (Bearer header or ?token= query param; legacy: KND_WORKER_TOKEN)
 */
...
if ($businessType === 'retail' && $isModuleTool) {
    ...
    if ($requiresConfirm && !$simulate) {
        $secret         = knd_agents_token() ?: 'fallback';
