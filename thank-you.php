    ...
    <div class="container text-center py-5">
        <div class="card knd-card mx-auto" style="max-width: 520px;">
            <div class="card-body py-5 px-4">
                ...
                <?php if ($ref): ?>
                <div class="checkout-info-box mb-4 p-3 text-start" style="background: var(--accent-action-subtle); border: 1px solid var(--accent-action-border); border-radius: 10px;">
                ...
                <?php else: ?>
                <div class="checkout-info-box mb-4 p-3" style="background: color-mix(in srgb, var(--color-warning) 10%, transparent); border: 1px solid color-mix(in srgb, var(--color-warning) 28%, transparent); border-radius: 10px;">
                    <p class="mb-0"><i class="fas fa-info-circle me-2" style="color: var(--color-warning);"></i>If you didn't receive an Order ID, please <a href="/contact.php" style="color: var(--accent-action);">contact support</a>.</p>
                </div>
                <?php endif; ?>
